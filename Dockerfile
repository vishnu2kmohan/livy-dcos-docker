FROM vishnumohan/miniconda3:4.3.31-3.6.3
...
RUN cd /tmp \
    ...
    && mkdir -p "${HADOOP_CONF_DIR}" "${LIBMESOS_BUNDLE_PREFIX}" \
...
ENV LIBMESOS_BUNDLE_PREFIX="${LIBMESOS_BUNDLE_PREFIX:-/opt/mesosphere}" \
